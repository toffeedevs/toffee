...
import TFGeneratorPage from "./pages/TFGeneratorPage";
        ...
        <AuthProvider>
            <Router>
                ...
                <Routes>
                    ...
                    <Route path="/generate/tf" element={user ? <TFGeneratorPage/> : <Navigate to="/login"/>}/>
                    <Route path="/generate/fitb" element={user ? <FITBGeneratorPage/> : <Navigate to="/login"/>}/>
                    <Route path="/generate/flashcards"
