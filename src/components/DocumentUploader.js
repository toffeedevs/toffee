        ...
        <div className="space-y-6">
            {!mode && (
                <div className="flex gap-4 flex-wrap">
                    <button onClick={() => setMode("text")}
                            className="bg-purple-700 text-white px-6 py-3 rounded-xl w-full hover:bg-purple-800">🔤 Paste Text
                    </button>
                    <button onClick={() => setMode("file")}
                            className="bg-purple-700 text-white px-6 py-3 rounded-xl w-full hover:bg-purple-800">📎 Upload File
                    </button>
                    <button onClick={() => setMode("youtube")}
                            className="bg-purple-700 text-white px-6 py-3 rounded-xl w-full hover:bg-purple-800">🎥 YouTube Link
                    </button>
                </div>
            )}
            ...
            {mode === "file" && (
                <>
                    ...
                    >
                        <p className="text-sm text-gray-300 mb-2">📎 Drag and drop a <code>.txt</code> or <code>.pdf</code> file here, or select one:</p>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button onClick={() => { setMode(null); setText(""); setFileName(""); }}
                                className="text-sm text-gray-400 underline">← Back
                        </button>
                    </div>
                </>
            ...
            {mode === "youtube" && (
                <>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button onClick={() => { setMode(null); setYoutubeUrl(""); }}
                                className="text-sm text-gray-400 underline">← Back
                        </button>
                    </div>
