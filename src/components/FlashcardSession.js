    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 flex flex-col items-center py-12 px-4">
            ...
            />
                    ...
                    {cardNotes.length > 0 && (
                        <div
                            className="mt-4 bg-gray-800/50 p-4 rounded-lg border border-gray-700 text-sm text-gray-300 space-y-2 max-w-xl w-full">
                ...
                <div
                    className="mt-8 p-6 bg-gray-800/80 rounded-2xl border-2 border-purple-700 text-center text-white w-full max-w-2xl shadow-lg">
